  ...
  const intermediateProjects: Project[] = [
    {
      ...
      features: ["Web Search", "SQLite Database", "Email Automation", "Dynamic Tool Calling"],
      techStack: ["Python", "Gemini 2.5 Flash", "SQLite", "SMTP"],
      githubUrl: "https://github.com/bismahashmi2/nexe-agent-internship/tree/main/intermediate/multi-tool-agent",
      liveDemo: null,
    },
    {
      title: "RAG Assistant",
      description: "A Retrieval-Augmented Generation system that enables semantic Q&A from PDF documents using embeddings and vector search.",
      features: ["PDF Processing", "Vector Search", "Semantic Retrieval", "Interactive Q&A"],
      techStack: ["Python", "ChromaDB", "SentenceTransformers", "PyPDF"],
      githubUrl: "https://github.com/bismahashmi2/nexe-agent-internship/tree/main/intermediate/RAG-assistant",
      liveDemo: null,
    },
  ];
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {intermediateProjects.map((project, index) => (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 hover:border-blue-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1"
              >
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    {project.liveDemo && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-200 text-center"
                      >
                        Live Demo
                      </a>
                    )}
